      ...
      <div className="relative z-10 flex items-center justify-center min-h-[600px] sm:min-h-[700px] md:min-h-[750px] px-4 py-10">
        <div className="text-center max-w-3xl w-full text-white p-4 sm:p-6 md:p-8 lg:p-12">
          ...
          <button
            ...
            className="mt-6 bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base md:text-lg px-6 sm:px-8 py-2 sm:py-3 rounded-full transition duration-300 shadow-md hover:shadow-lg"
          >
            Order Now
          </button>
        </div>
